...
const allAchievements: Achievement[] = [
  ...
  { id: "A302", name: "非酋翻身", emoji: "🎰", description: "触发天命保底（100 次未出传说）", category: "hidden", condition: { type: "pityTriggered" }, expReward: 100, titleReward: "大器晚成" },
